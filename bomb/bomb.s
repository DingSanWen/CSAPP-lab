...
0000000000400efc <phase_2>:
  400efc:	55                   	push   %rbp
  400efd:	53                   	push   %rbx
  400efe:	48 83 ec 28          	sub    $0x28,%rsp                 # allocate 5 bytes int[6]
  400f02:	48 89 e6             	mov    %rsp,%rsi
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)                # int[0] = 1
  400f0e:	74 20                	je     400f30 <phase_2+0x34>
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax
  400f1a:	01 c0                	add    %eax,%eax                # int[n] = 2 * int[n - 1]
  400f1c:	39 03                	cmp    %eax,(%rbx)
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx
  400f29:	48 39 eb             	cmp    %rbp,%rbx
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>    # loop
...
0000000000400f43 <phase_3>:
  ...
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi         # %d %d %s
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt>   # read 2 number, maybe
  400f60:	83 f8 01             	cmp    $0x1,%eax
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)         # big than 7, bomb . first number should be small than 7
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax           # eax 0
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)      # weird jump
...
0000000000400fce <func4>:     # edi a, y in esi 0, z in edx 14
  400fce:	48 83 ec 08          	sub    $0x8,%rsp
  400fd2:	89 d0                	mov    %edx,%eax
  400fd4:	29 f0                	sub    %esi,%eax  # res = z - y
  400fd6:	89 c1                	mov    %eax,%ecx
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx # int t = sign(res)
  400fdb:	01 c8                	add    %ecx,%eax  # res += sign
  400fdd:	d1 f8                	sar    %eax       # res /= 2
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx # t = res + y
  400fe2:	39 f9                	cmp    %edi,%ecx          # t <= a
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx    #  -t
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4>
  400fee:	01 c0                	add    %eax,%eax
  400ff0:	eb 15                	jmp    401007 <func4+0x39>
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax        # t = a return 0
  400ff7:	39 f9                	cmp    %edi,%ecx        # t >= a
...
000000000040100c <phase_4>:
  ...
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt>  # read two number
...
0000000000401062 <phase_5>:
  ...
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx   # first char in ecx
  40108f:	88 0c 24             	mov    %cl,(%rsp)         # put first char to stack frame
  401092:	48 8b 14 24          	mov    (%rsp),%rdx
  401096:	83 e2 0f             	and    $0xf,%edx
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx  

  # read char from this address, using last four bits of input char as offset.
  # offset should be 9 f e 5 6 7, find char whose last four bits is offset from ascii
  ...
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi       # wanted string
...
00000000004010f4 <phase_6>:
  ...
  # all number is no bigger than  6 and bigger than 0
  ...
  401128:	41 83 c4 01          	add    $0x1,%r12d             # %r12d is 1
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d
  401130:	74 21                	je     401153 <phase_6+0x5f>
  401132:	44 89 e3             	mov    %r12d,%ebx

  # no number is equal to the first
    401135:	48 63 c3             	movslq %ebx,%rax
    401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax     # the 5th number
...
# maybe 2 loop left, or more
  40116f:	be 00 00 00 00       	mov    $0x0,%esi
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>
  # store 6 address to frame, it's a lined list
...
000000000040131b <string_length>: a in rdi
  40131b:	80 3f 00             	cmpb   $0x0,(%rdi)
  40131e:	74 12                	je     401332 <string_length+0x17>
  401320:	48 89 fa             	mov    %rdi,%rdx  t = a

  401323:	48 83 c2 01          	add    $0x1,%rdx  t = t + 1
  401327:	89 d0                	mov    %edx,%eax  
  401329:	29 f8                	sub    %edi,%eax  res = t - a
...
0000000000401338 <strings_not_equal>:                                     return 0 if length of a equals length of b, otherwise return 1
  401338:	41 54                	push   %r12
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx

  40133c:	48 89 fb             	mov    %rdi,%rbx                           first argument char *a store in rbx
  40133f:	48 89 f5             	mov    %rsi,%rbp                           second argument char *b store in rbp
  401342:	e8 d4 ff ff ff       	callq  40131b <string_length>
  401347:	41 89 c4             	mov    %eax,%r12d                         length of a in r12d
  40134a:	48 89 ef             	mov    %rbp,%rdi
  40134d:	e8 c9 ff ff ff       	callq  40131b <string_length>
  401352:	ba 01 00 00 00       	mov    $0x1,%edx
  401357:	41 39 c4             	cmp    %eax,%r12d
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63>    if length of a != length of b, return 1 
  40135c:	0f b6 03             	movzbl (%rbx),%eax
  40135f:	84 c0                	test   %al,%al                            if &a = 0, return 0;
  401361:	74 25                	je     401388 <strings_not_equal+0x50>
  401363:	3a 45 00             	cmp    0x0(%rbp),%al                      if &a == &b, 
  ...
  401372:	48 83 c3 01          	add    $0x1,%rbx                          a += 1
  401376:	48 83 c5 01          	add    $0x1,%rbp                          b += 1
